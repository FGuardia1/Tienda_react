                    ...
                    <div className="card-body ">
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-7 col-md-5 ">
                                ...
                                <h2 className="m-3">${precio} </h2> 
                                {  
                                    quantitySelected>0?<button className="btn btn-primary"><Link className="text-decoration-none text-white" to='/cart'>Seguir compra</Link></button>:<ItemCount  stock={stock} initial={1} setQuantitySelected={setQuantitySelected} productData={data} />
                                }
